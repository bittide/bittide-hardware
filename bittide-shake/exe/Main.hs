...
targets =
  map enforceValidTarget $
    ...
    , defTarget $ mkName "Bittide.Instances.Pnr.Ringbuffer.transmitRingbufferRamOnlyPnr"
    , defTarget $ mkName "Bittide.Instances.Pnr.Ringbuffer.transmitRingbufferFilterOnlyPnr"
    , defTarget $ mkName "Bittide.Instances.Pnr.Ringbuffer.transmitRingbufferBramOnlyPnr"
