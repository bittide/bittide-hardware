...
The Scatter Unit exposes the following registers via the Wishbone interface:

| Name | Access | Description |
|---|---|---|
| `scatterMemory` | Read-Only | The memory buffer containing the scattered data. The size depends on the configuration. |
