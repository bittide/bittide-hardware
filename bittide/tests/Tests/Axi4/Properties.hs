...
tests :: TestTree
tests = testGroup "Tests.Axi4.Properties"
...
isPackedAxi4StreamPacket =
  all (== NullByte) .       -- There should not be data or position bytes left
  dropWhile (/= NullByte) . -- Find first null byte -- Find first null byte
  dropWhile (== NullByte)   -- Find first data or position byte
...
isStrictlySparseAxi4StreamPacket =
  elem DataByte .               -- There should still be data bytes left
  dropWhile (/= PositionByte) . -- Find first position byte -- Find first position byte
  dropWhile (/= DataByte)       -- Find first data byte
...
case_isPackedAxi4StreamPacket = do
  ...
  HU.assertBool "expected unpacked" $ (not . isPackedAxi4StreamPacket) [DataByte, NullByte, DataByte]
  HU.assertBool "expected unpacked" $ (not . isPackedAxi4StreamPacket) [NullByte, PositionByte, NullByte, PositionByte]
  HU.assertBool "expected unpacked" $ (not . isPackedAxi4StreamPacket) [NullByte, DataByte, NullByte, PositionByte]
  HU.assertBool "expected unpacked" $ (not . isPackedAxi4StreamPacket) [DataByte, NullByte, PositionByte, NullByte]
...
case_isStrictlySparseAxi4StreamPacket = do
  ...
  HU.assertBool "expected not sparse" $ (not . isStrictlySparseAxi4StreamPacket) [PositionByte]
  HU.assertBool "expected not sparse" $ (not . isStrictlySparseAxi4StreamPacket) [DataByte, NullByte]
  HU.assertBool "expected not sparse" $ (not . isStrictlySparseAxi4StreamPacket) [PositionByte, NullByte]
  HU.assertBool "expected not sparse" $ (not . isStrictlySparseAxi4StreamPacket) [PositionByte, DataByte]
  HU.assertBool "expected not sparse" $ (not . isStrictlySparseAxi4StreamPacket) [PositionByte, DataByte, PositionByte]
  HU.assertBool "expected sparse" $ isStrictlySparseAxi4StreamPacket [DataByte, PositionByte, DataByte, PositionByte]
  HU.assertBool "expected sparse" $ isStrictlySparseAxi4StreamPacket [DataByte, PositionByte, DataByte]
  HU.assertBool "expected sparse" $ isStrictlySparseAxi4StreamPacket [DataByte, PositionByte, DataByte, NullByte]
  HU.assertBool "expected sparse" $ isStrictlySparseAxi4StreamPacket [PositionByte, DataByte, PositionByte, DataByte]
...
case_isUnalignedAxi4StreamPacket = do
  ...
  HU.assertBool "expected unaligned" $ isUnalignedAxi4StreamPacket [PositionByte, DataByte, PositionByte]
  HU.assertBool "expected unaligned" $ isUnalignedAxi4StreamPacket [PositionByte, NullByte, DataByte, PositionByte]
  HU.assertBool "expected unaligned" $ isUnalignedAxi4StreamPacket [NullByte, DataByte, PositionByte]
  HU.assertBool "expected unaligned" $ isUnalignedAxi4StreamPacket [DataByte, PositionByte, NullByte]
  ...
  HU.assertBool "expected not unaligned" $ not $ isUnalignedAxi4StreamPacket [DataByte, PositionByte, DataByte]
  HU.assertBool "expected not unaligned" $ not $ isUnalignedAxi4StreamPacket [PositionByte, DataByte, PositionByte, DataByte]
  HU.assertBool "expected not unaligned" $ not $ isUnalignedAxi4StreamPacket [DataByte, PositionByte, DataByte, PositionByte]
...
case_unInterruptedAxi4Packets = do
  ...
  HU.assertBool "expected uninterrupted" $ unInterruptedAxi4Packets [Nothing, lastTransfer, Nothing]
  HU.assertBool "expected uninterrupted" $ unInterruptedAxi4Packets [Nothing, payloadTransfer, lastTransfer]
  HU.assertBool "expected uninterrupted" $ unInterruptedAxi4Packets [payloadTransfer, payloadTransfer, lastTransfer]
  HU.assertBool "expected uninterrupted" $ unInterruptedAxi4Packets [lastTransfer, payloadTransfer, lastTransfer]
  HU.assertBool "expected not uninterrupted" $ unInterruptedAxi4Packets [lastTransfer, Nothing, payloadTransfer, lastTransfer]
  HU.assertBool "expected not uninterrupted" $ not $ unInterruptedAxi4Packets [Nothing, payloadTransfer, Nothing, lastTransfer]
 where
...
case_isSinglePacket = do
  ...
  HU.assertBool "expected not single packet" $ not $ isSinglePacket [lastTransfer, payloadTransfer]
  HU.assertBool "expected not single packet" $ not $ isSinglePacket [lastTransfer, payloadTransfer, lastTransfer]
 where
...
case_hasLeadingNullBytes = do
  ...
  HU.assertBool "expected not leading null bytes" $ not $ hasLeadingNullBytes [DataByte, NullByte]
...
case_hasTrailingNullBytes = do
  ...
  HU.assertBool "expected not trailing null bytes" $ not $ hasTrailingNullBytes [NullByte, DataByte]

mkDummyM2S :: Vec 4 Bool -> Bool -> Axi4StreamM2S ('Axi4StreamConfig 4 0 0 ) ()
mkDummyM2S keep last0 = Axi4StreamM2S
  { _tdata = repeat 0
  , _tkeep = keep
  , _tstrb = repeat True
  , _tlast = last0
