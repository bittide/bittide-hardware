...
timesDivRU = unsafeCoerce (Dict :: Dict (a ~ a))
...
cancelMulDiv = unsafeCoerce (Dict :: Dict (a ~ a))
...
divWithRemainder ::
  ...
  (1 <= b, c <= (b - 1)) =>
  Dict (Div ((a * b) + c) b ~ a)
divWithRemainder = unsafeCoerce (Dict :: Dict (a ~ a))
...
strictlyPositiveDivRu = unsafeCoerce (Dict :: Dict (a ~ a))
...
euclid3 = unsafeCoerce (Dict :: Dict (a ~ a))
...
oneLeCLog2n = unsafeCoerce unsafeCoerce (Dict :: Dict (a ~ a))
...
useLowerLimit = unsafeCoerce (Dict :: Dict (a ~ a))
