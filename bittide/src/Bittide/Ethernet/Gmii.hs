...
data GmiiRx = GmiiRx
  { gmiiRxData  :: "Data" :::  BitVector 8
  , gmiiRxValid :: "Valid" :::  Bool
  , gmiiRxError :: "Error" :::  Bool
  }

data GmiiTx = GmiiTx
  { gmiiTxData   :: "Data" ::: BitVector 8
  , gmiiTxEnable :: "Enable" ::: Bool
  , gmiiTxError  :: "Error" ::: Bool
  }
...
axiGmiiRxC ::
  ...
  Signal dom Bool ->
  Signal dom Bool ->
  Circuit (CSignal dom GmiiRx) (Axi4Stream dom ('Axi4StreamConfig 1 0 0) AxiGmiiRxUser)
...
data AxiGmiiRxUser = AxiGmiiRxUser
...
axiGmiiRx ::
  ...
  Signal dom (Maybe (Axi4StreamM2S ('Axi4StreamConfig 1 0 0) AxiGmiiRxUser))
...
axiGmiiRxBb !_ !_ !_ !_ !_ !_ !_ !_ = deepErrorX "No simulation model for axiGmiiRxBb"
...
axiGmiiTx clk rst clkEnable cfgEnable miiSelect axiM2S =
 ...
 where
  ...
  gmiiTx = GmiiTx <$> gmiiData <*> gmiiEnable <*> gmiiError
...
axiGmiiTxBb !_ !_ !_ !_ !_ !_ !_ !_ = deepErrorX "No simulation model for axiGmiiTxBb"
