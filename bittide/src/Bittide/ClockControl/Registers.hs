...
-- | Address         | Access | Name                                               |
-- |-----------------|--------|----------------------------------------------------|
-- | 0               | RO     | Number of links                                    |
-- | 1               | RO     | Active link mask                                   |
-- | 2               | WO     | FINC/FDEC                                          |
-- | 3               | RO     | Link stable. LSB represents node 0.                |
-- | 4               | RO     | Link settled (around zero). LSB represents node 0. |
-- | 5 to 5 + nLinks | RO     | Data counts                                        |
-- @
clockControlWb ::
  ...
  -- | Data counts from (virtual) buffers
