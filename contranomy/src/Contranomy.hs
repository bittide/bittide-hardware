...
contranomy' clk rst entry iMem dMem (unbundle -> (tI, sI, eI)) =
 ...
 where
  ...
  (dMemS2M, unbundle -> (dMappediMemM2S :> dMemM2S :> Nil)) =
    withClockResetEnable clk rst enableGen $ memoryMap (0x0000_0000 :> 0x5000_0000 :> Nil) dataM2S $ bundle (iMemMapped :> dStorage :> Nil)
