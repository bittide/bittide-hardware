...
/// Number of bytes in an FPGA DNA identifier.
pub const N_DNA_BYTES: usize = 12;

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub struct UgnEdge {
    pub src_node: [u8; N_DNA_BYTES],
    pub src_port: u32,
    pub dst_node: [u8; N_DNA_BYTES],
    pub dst_port: u32,
    pub ugn: i64,
}
...
struct UgnEdgeWire {
    src_node: [u8; N_DNA_BYTES],
    dst_node: [u8; N_DNA_BYTES],
    src_port: U32<LE>,
    dst_port: U32<LE>,
    ugn: I64<LE>,
}
