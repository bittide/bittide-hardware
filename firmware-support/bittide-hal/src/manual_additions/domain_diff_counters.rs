...
impl_domain_diff_counters_interface!(
    crate::hals::soft_ugn_demo_clock_control::devices::DomainDiffCounters
);
impl_domain_diff_counters_interface!(
    crate::hals::wire_demo_clock_control::devices::DomainDiffCounters
);
