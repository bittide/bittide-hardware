...
/// This file contains helper functions for working with transmit ring buffers.
///
/// Because there are multiple different implementations of transmit ring
/// buffers (due to slight differences in register types) this code would need
/// to be generic. As C doesn't have generics, this file instead depends on the
/// specific transmit ring buffer header file to be included to use the correct
/// interface.
...
#ifdef HAL_SOFT_UGN_DEMO_MANAGEMENT_UNIT_DEVICE_TRANSMIT_RING_BUFFER_H
#include "hals/soft_ugn_demo_management_unit/devices/transmit_ring_buffer.h"
