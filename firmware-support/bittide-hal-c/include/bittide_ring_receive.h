...
/// This file contains helper functions for working with receive ring buffers.
///
/// Because there are multiple different implementations of receive ring buffers
...
/// receive ring buffer header file to be included to use the correct interface.
