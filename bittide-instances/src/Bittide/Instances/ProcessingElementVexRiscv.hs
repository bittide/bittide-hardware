...
module Bittide.Instances.ProcessingElementVexRiscv where
...
vexRiscv :: Clock System -> Reset System -> Signal System (Unsigned 8)
vexRiscv clk rst = out
 where
  (wbM2S :> Nil) =
    withClockResetEnable clk rst enableGen $ vexRiscvProcessingElement peConfig (wbS2M :> Nil)
