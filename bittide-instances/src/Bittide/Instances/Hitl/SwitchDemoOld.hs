...
import Bittide.Instances.Hitl.Driver.SwitchDemo (ccWhoAmID, muWhoAmID, whoAmIPrefix)
...
import {-# SOURCE #-} qualified Bittide.Instances.Hitl.Driver.SwitchDemoOld as D
