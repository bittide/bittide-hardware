...
swCcTopologyTest refClkDiff sysClkDiff syncIn1 rxns rxps miso =
 ...
 where
  ...
  ilaControl@IlaControl{..} = ilaPlotSetup IlaPlotSetup{syncIn = syncIn2, ..}
  ...
  syncIn2 = mux syncNodePrevEnteredReset syncIn1 (pure True :: Signal Basic125 Bool)
  testCounter =
    regEn
      sysClk
      sysRst
