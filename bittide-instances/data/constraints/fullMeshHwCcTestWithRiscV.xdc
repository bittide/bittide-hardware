...
# GPIO_LED_0_LS
set_property BOARD_PART_PIN GPIO_LED_1_LS [get_ports "linkUps[0]"]
# GPIO_LED_1_LS
set_property BOARD_PART_PIN GPIO_LED_2_LS [get_ports "linkUps[1]"]
# GPIO_LED_2_LS
set_property BOARD_PART_PIN GPIO_LED_3_LS [get_ports "linkUps[2]"]
# GPIO_LED_3_LS
set_property BOARD_PART_PIN GPIO_LED_4_LS [get_ports "linkUps[3]"]
# GPIO_LED_4_LS
set_property BOARD_PART_PIN GPIO_LED_5_LS [get_ports "linkUps[4]"]
# GPIO_LED_5_LS
