...
set_property BOARD_PIN {USB_UART_RX} [get_ports USB_UART_RX]
set_property BOARD_PIN {USB_UART_TX} [get_ports USB_UART_TX]
...
set_property BOARD_PIN {SGMII_RX_P} [get_ports SGMII_RX_P]
set_property BOARD_PIN {SGMII_RX_N} [get_ports SGMII_RX_N]
set_property BOARD_PIN {SGMII_TX_P} [get_ports SGMII_TX_P]
set_property BOARD_PIN {SGMII_TX_N} [get_ports SGMII_TX_N]
set_property BOARD_PIN {SGMIICLK_P} [get_ports SGMIICLK_P]
set_property BOARD_PIN {SGMIICLK_N} [get_ports SGMIICLK_N]
...
proc set_jtag_timing_constraints { } {
    ...
    # ---customize here---
    set use_fitter_specific_constraint 0
...
proc set_default_quartus_fit_timing_directive { } {
    ...
    create_clock -name {JTAG_TCK} -period $jtag_33Mhz_t_period [get_ports {JTAG_TCK}]
    ...
    set_max_delay -to [get_ports { JTAG_TDO } ] 0
}
...
proc set_jtag_timing_spec_for_timing_analysis { } {
    ...
    #     set_false_path -from [get_registers *~jtag_reg] -to [get_ports {JTAG_TDO}]
    # }
...
proc set_tck_timing_spec { } {
    ...
    create_clock -name {JTAG_TCK} -period $tck_t_period  [get_ports {JTAG_TCK}]
    set_clock_groups -asynchronous -group {JTAG_TCK}
}

proc get_tck_delay_max { } {
    set tck_blaster_tco_max 14.603
    set tck_cable_max 2.000
...
proc set_tms_timing_spec { } {
    ...
    set tms_cable_max 2.000
    set tms_cable_min 0.373
    ...
    set_input_delay -add_delay -clock_fall -clock JTAG_TCK -max $tms_in_max [get_ports {JTAG_TMS}]
    set_input_delay -add_delay -clock_fall -clock JTAG_TCK -min $tms_in_min [get_ports {JTAG_TMS}]
}
...
proc set_tdi_timing_spec_when_driven_by_blaster { } {
    ...
    set tdi_cable_max 2.000
    set tdi_cable_min 0.373
    ...
    set_input_delay -add_delay -clock_fall -clock JTAG_TCK -max $tdi_in_max [get_ports {JTAG_TDI}]
    set_input_delay -add_delay -clock_fall -clock JTAG_TCK -min $tdi_in_min [get_ports {JTAG_TDI}]
}
...
proc set_tdo_timing_spec_when_drive_blaster { } {
    ...
    set tdo_cable_max 2.000
    set tdo_cable_min 0.373
    ...
    set_output_delay -add_delay -clock_fall -clock JTAG_TCK -max $tdo_out_max [get_ports {JTAG_TDO}]
    set_output_delay -add_delay -clock_fall -clock JTAG_TCK -min $tdo_out_min [get_ports {JTAG_TDO}]
}
...
proc set_tdo_timing_spec_when_drive_device { } {
    ...
    set_output_delay -add_delay -clock JTAG_TCK -max $tdo_out_max [get_ports {JTAG_TDO}]
    set_output_delay -add_delay -clock JTAG_TCK -min $tdo_out_min [get_ports {JTAG_TDO}]
}
