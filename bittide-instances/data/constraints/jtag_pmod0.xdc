...
set_property -dict {IOSTANDARD LVCMOS12 PACKAGE_PIN AK25} [get_ports {JTAG_UART_RXD}]
set_property -dict {IOSTANDARD LVCMOS12 PACKAGE_PIN AN21} [get_ports {JTAG_UART_TXD}]
